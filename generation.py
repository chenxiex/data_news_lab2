...
#将每次的输入打包成一个batch送进模型进行预测（生成），一次
...
def main(title):
    ...
    # parser.add_argument('--no_wordpiece', action='store_true', help='不做word piece切词') #可忽略
    parser.add_argument('--segment', action='store_true', help='以词为单位') #和word piece区别
    # 在生成时，复用之前输入的k,v向量（对原理感兴趣可以看一下https://zhuanlan.zhihu.com/p/402445511）
